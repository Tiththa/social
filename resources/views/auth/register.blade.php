    ...
    <x-jet-authentication-card>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    <x-jet-label value="{{ __('Real Name') }}" />
                ...
                <div class="mb-3">
                    ...
                    <x-jet-input class="{{ $errors->has('password') ? 'is-invalid' : '' }} pr-password" type="password"
                ...
                <div class="mb-0">
                    <div class="d-flex justify-content-end align-items-baseline">
                        ...
                        <button type="submit" class="btn btn-dark text-uppercase g-recaptcha"
                                id="register-btn"
...
{{--                        </x-jet-button>--}}
        ...
        @push('scripts')
            ...
            <script src="https://www.google.com/recaptcha/api.js?render=6LcTNVkcAAAAAA6gmtuEQSCdpTfpZWt1oUtMO8rm"></script>
            <script>
                function onSubmit(token) {
                    document.getElementById("register-btn").submit();
                }
